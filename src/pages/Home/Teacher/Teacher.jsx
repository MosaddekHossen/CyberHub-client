            ...
            <div className="max-w-7xl mx-auto mt-10 md:mt-20 lg:mb-16 md:mb-5 mb-4" data-aos="zoom-in">
                ...
                <div className="lg:h-full">
                    <div className="hero-content flex-col lg:flex-row">
                        <img className="lg:w-1/2 w-full lg:h-full md:h-[400px]" src="https://img.freepik.com/free-vector/teacher-class-world-teacher-s-day_23-2147666022.jpg?w=740&t=st=1703619105~exp=1703619705~hmac=ff0e830093ce72ecfda8642e34b133524a6351d5fc022b37f5bbdbb55768a9ea" />
