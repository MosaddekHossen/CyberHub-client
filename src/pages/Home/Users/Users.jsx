...
const Users = () => {
    return (
        <div>
            <SectionTitle
                heading={"Website Analytics at a Glance"}
            ></SectionTitle>
            <section className="text-gray-100 rounded-xl bg-slate-300 p-10 md:py-20 py-16">
                <div className="container grid grid-cols-1 gap-6 m-4 mx-auto md:m-0 md:grid-cols-2 xl:grid-cols-3">
                    <div className="flex overflow-hidden rounded-lg dark:bg-gray-700 dark:text-gray-100">
                        ...
                        <div className="flex items-center justify-center px-4 dark:bg-violet-300 dark:text-gray-800">
                    ...
                    <div className="flex overflow-hidden rounded-lg dark:bg-gray-700 dark:text-gray-100">
                        ...
                        <div className="flex justify-center p-2 align-middle rounded-lg sm:p-4 dark:bg-violet-300">
